...
def main(data_path,rewrite_path):
    ...
    args.model_name_or_path='../../model/contriever-msmarco'
    args.passages='../psgs_w100.tsv'
    args.passages_embeddings="../wikipedia_embeddings/*"
    args.output_dir='retr_result/L2'
    args.n_docs=50
    ...
    index = src.index.Indexer(args.projection_size, args.n_subquantizers, args.n_bits, mode='simple')
    #efSearch = 1500
